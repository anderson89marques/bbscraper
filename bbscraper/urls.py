...
SALDO_URL = 'https://mobi.bb.com.br/mov-centralizador/servico/ServicoSaldo/saldo'
TRANSACOES_URL = 'https://mobi.bb.com.br/mov-centralizador/tela/ExtratoDeContaCorrente/extrato'

# Essas url não são utilizadas pelo  script do Kamus, eu preciso entender para que servem
